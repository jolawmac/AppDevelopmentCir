...
let timeGettingReady = brushTeeth + shower + goJogging + fixLunch + chooseClothes
let poop = 4
let newTimeGettingReady = timeGettingReady + poop
...
let thingsILikeToDo = shower + goJogging
let thingsIHaveToDo = brushTeeth + fixLunch + chooseClothes + poop
